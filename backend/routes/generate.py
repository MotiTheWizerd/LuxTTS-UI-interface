...
from backend.utils.temp_file import temp_audio_file
...
def generate():
    ...
    with temp_audio_file(request.files["prompt_audio"]) as tmp_path:
        try:
            model = model_manager.get_model()
            encoded_prompt = model.encode_prompt(
                tmp_path, duration=params.duration, rms=params.rms
            )
